...
def room2(win, inventory):
    ...
    # drawing room
    img2 = Image(Point(20, 10), "room2.gif")
    img2.draw(win)

    # drawing user
    user = Image(Point(28,1), "thief.gif")
    user.draw(win)
    ...
    observe_in_room = {"Point(14.0,3.0)": "The door will open if you say a word ALOHOMORA 3 times"}
    ...
    while continueGame is True and lost is False:
        ...
        if usx >= Point(18.0, 12.0).getX() and usx <= Point(22.0, 12.0).getX() and usy >= Point(10.0,
            ...
            if observed:
                ...
                storytell(win,"Good Job! You passed the second room because you knew that the spell 'Alohomora' opens the door.")
                user.undraw()
                img2.undraw()
                ...
                storytell(win,"You do not have an item in your inventory that will help you open the door.")
