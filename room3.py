...
def room3(win, inventory):
  ...
  # drawing room
    img3 = Image(Point(20, 10), "room3.gif")
    img3.draw(win)
  ...
  #set the points of the items
    ...
    observe_in_room = {"Point(22.0,15.0)": "Mom, the piece of the puzzle is hidden in the kitchen! It should be a piece of cake! P.S. The fridge is very cold, remember!"}
    ...
    while continueGame is True and lost is False:
      ...
      # Activating a pickup button if the user is standing on an item that they can pick up
        ...
        if main_item in inventory:
            ...
            storytell(win,"Good Job! You passed the third room because you figured out that you would need a towel to open a fridge, and you also got the 'cake' mentioned in hint.")
            user.undraw()
            img3.undraw()
